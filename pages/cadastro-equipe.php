...
<div class="container mt-5">
  <div class="card shadow">
    <div class="card-header bg-primary text-white">
      <h4 class="mb-0"><i class="bi bi-person-plus me-2"></i>Cadastro de Funcionário</h4>
    </div>
    <div class="card-body">
      ...
      <div class="mb-3">
        ...
        <button name="acao" type="submit" class="btn btn-success w-100"><i class="bi bi-save me-2"></i>Cadastrar Equipe</button>
      </form>
    </div>
  </div>
</div>
